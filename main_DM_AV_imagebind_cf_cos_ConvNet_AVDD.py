...
from utils.train_utils_DM import evaluate_synset_av, get_network, get_network_imagebind, get_network_vgg11
...
if __name__ == '__main__':
    ...
    parser.add_argument('--interval', type=int, default=5000, help='interval to evaluate the synthetic data')
