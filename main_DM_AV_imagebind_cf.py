    ...
    for exp in range(args.num_exp):
        ...
        for it in tqdm(range(args.Iteration+1)):
            ...
            for c in range(num_classes):
                ...
                # print("embd_aud_real shape:", embd_aud_real.shape)
                # print("embd_img_real shape:", embd_img_real.shape)
                # print("embd_aud_syn shape:", embd_aud_syn.shape)
                # print("embd_img_syn shape:", embd_img_syn.shape)
                ...
                if args.input_modality == 'av':                    
                    ...
                    # loss_c += args.lam_cgm*match_loss(embd_aud_real + embd_img_syn, embd_img_real + embd_aud_syn, args)
