...
class ClothoExperiment:
    ...
    def run_complete_experiment(self, args):
        ...
        distilled_datasets = [
            ...
            # 【注意】我们在此处将 ImageBindDC 改名为 Ours
            ("Ours", result_ibdc, (eval_imagebind_audio, eval_imagebind_text)),
        ...
        tsne_data_to_plot.sort(key=lambda x: {"DM_ImageBind": 0, "AVDD_ImageBind": 1, "Ours": 2}.get(x['name'], 99))
