...
from utils.old_data_utils import get_train_dataset, get_test_dataset, ParamDiffAug
from utils.old_train_utils_DM import get_network, train_expert_epoch, test_expert_epoch #
...
def main(args):
    ...
    for it in range(0, args.num_experts):
        ...
        _, teacher_net = get_network(args)
        ...
        print("Teacher sound network:", teacher_net.net_sound)
