...
# 文件和文件夹路径
txt_file = 'data/AVE_Dataset/trainSet.txt'
videos_dir = 'data/AVE_Dataset/AVE'
audios_dir = 'data/train_data/ave/audios'
frames_dir = 'data/train_data/ave/frames'
output_json = 'data/train_data/ave_train.json'
category_dict_file = 'data/train_data/ave_category_dict.json'
...
with open(txt_file, 'r', encoding='utf-8') as f:
    for line in f:
        ...
        # 处理每个1秒片段
        for sec in tqdm(range(start_time, end_time)):
