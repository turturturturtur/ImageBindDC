        ...
        for c in range(num_classes):
            if not args.idm_aug:
                ...
                if args.input_modality == 'a' or args.input_modality == 'av':
                    ...
                    aud_syn.data[c*args.ipc:(c+1)*args.ipc] = aud_real_init.unsqueeze(2)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--lr_syn_aud', type=float, default=0.005, help='learning rate for updating synthetic audio specs')
    parser.add_argument('--lr_syn_img', type=float, default=0.005, help='learning rate for updating synthetic image')
