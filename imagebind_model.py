...
def imagebind_huge(pretrained=False):
    ...
    if pretrained:
        if not os.path.exists("checkpoint/imagebind_huge.pth"):
            print(
            ...
            torch.hub.download_url_to_file(
                ...
                "checkpoint/imagebind_huge.pth",
                progress=True,
            )

        model.load_state_dict(torch.load("checkpoint/imagebind_huge.pth"),strict=False)
